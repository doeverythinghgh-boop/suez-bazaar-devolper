...
*   **إنشاء حساب**: يدعم تكامل الخريطة وقفل النافذة العرضي. يتم تخزين الإحداثيات مؤقتاً ومعالجتها عبر "التحديث دفعة واحدة (Batch Update)" عند الحفظ النهائي.
*   **الملف الشخصي**: يعتمد على "التحديث المحلي أولاً" عند اختيار موقع جديد من الخريطة، مع عرض رسائل ذكية (Smart UI) بناءً على حالة ربط الموقع، ولا يتم الحفظ السحابي إلا عند ضغط زر "حفظ التغييرات".
